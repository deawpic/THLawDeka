...
# Prerequisites & Authentication
 ...
 - ไฟล์ .env เก็บค่า  DEKA_API_KEY , FC_API_KEY ,  TL_API_KEY แยกบรรทัดกันชัดเจน ตามตัวอย่าง:
      DEKA_API_KEY=
      FC_API_KEY=
      TL_API_KEY=
...
- ถ้า API_KEY ว่างให้ถาม user ดังนี้
    ...
    3. เพิ่ม thailegal api key. (ถ้าเลือกข้อนี้ให้ถามให้ user  paste key แล้วนำค่าไปเก็บใน TL_API_KEY จากนั้นใช้ skill tl_mcp เพื่อตั้งค่า mcp ให้เสร็จ)
    4. ข้ามไปก่อน
